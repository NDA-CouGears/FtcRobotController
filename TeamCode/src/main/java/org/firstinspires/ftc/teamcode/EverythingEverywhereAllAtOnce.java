...
@Autonomous(name = "Everything Everywhere All At Once", group = "Concept")
public class EverythingEverywhereAllAtOnce extends LinearOpMode {
    ...
    public void encoderDrive1(double speed,
        ...
        if (opModeIsActive()) {
            ...
            // Determine new target position, and pass to motor controller
            newLeftFrontTarget = leftFrontDrive.getCurrentPosition() + (int)(25.4*leftInches * COUNTS_PER_MM);
            newLeftBackTarget = leftBackDrive.getCurrentPosition() + (int)(25.4*leftInches * COUNTS_PER_MM);
            newRightFrontTarget = rightFrontDrive.getCurrentPosition() + (int)(25.4*rightInches * COUNTS_PER_MM);
            newRightBackTarget = rightBackDrive.getCurrentPosition() + (int)(25.4*rightInches * COUNTS_PER_MM);
            leftFrontDrive.setTargetPosition(newLeftFrontTarget);
            leftBackDrive.setTargetPosition(newLeftBackTarget);
            rightFrontDrive.setTargetPosition(newRightFrontTarget);
            rightBackDrive.setTargetPosition(newRightBackTarget);
